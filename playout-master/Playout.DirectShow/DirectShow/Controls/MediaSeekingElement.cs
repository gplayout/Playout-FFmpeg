...
namespace Playout.DirectShow.Controls
{
    ...
    public abstract class MediaSeekingElement : MediaElementBase
    {
        ...
        public static readonly DependencyProperty MediaPositionPlusOffsetProperty =
            DependencyProperty.Register("MediaPositionPlusOffset", typeof(long), typeof(MediaSeekingElement),
                                        new FrameworkPropertyMetadata((long)0, null));

        public bool DontChangeMediaPositionOnNextCall { get; set; }
        /// <summary>
        ...
        public long MediaPositionPlusOffset
        {
            get
            {
                return (long)GetValue(MediaPositionPlusOffsetProperty);
            }
            set
            {
                SetValue(MediaPositionPlusOffsetProperty, value);
            }
        }
        public long MediaPosition
        {
            get 
            {
                var pos = (long)GetValue(MediaPositionProperty);
                return pos;
            }
            set 
            {
                if(this.DontChangeMediaPositionOnNextCall)
                {
                    this.DontChangeMediaPositionOnNextCall = false;
                    return;
                }
        ...
        public long MediaDuration
        {
            get 
            {
                var val = (long)GetValue(MediaDurationProperty);
                return val; 
            }
        }
