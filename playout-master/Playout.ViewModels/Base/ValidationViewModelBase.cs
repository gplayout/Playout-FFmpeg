using Playout.ViewModels.Services;
using System;
...
{
    public class ValidationViewModelBase : BaseViewModel, IDataErrorInfo, IValidationExceptionHandler
    {
        ...
        public void ValidationExceptionsChanged(int count)
        {
            ...
            this.NotifyOfPropertyChange(() => this.ValidPropertiesCount);
        }
    }
}
