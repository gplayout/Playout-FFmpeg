...
namespace DirectShow
{
    ...
    [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown), System.Security.SuppressUnmanagedCodeSecurity, Guid("54C39221-8380-11d0-B3F0-00AA003761C5")]
    public interface IAMAudioInputMixer
    {
        [PreserveSig]
        int put_Enable([In, MarshalAs(UnmanagedType.Bool)] bool fEnable);
        [PreserveSig]
        int get_Enable([MarshalAs(UnmanagedType.Bool)] out bool pfEnable);
        [PreserveSig]
        int put_Mono([In, MarshalAs(UnmanagedType.Bool)] bool fMono);
        [PreserveSig]
        int get_Mono([MarshalAs(UnmanagedType.Bool)] out bool pfMono);
        [PreserveSig]
        ...
        [PreserveSig]
        int get_Loudness([MarshalAs(UnmanagedType.Bool)] out bool pfLoudness);
        [PreserveSig]
