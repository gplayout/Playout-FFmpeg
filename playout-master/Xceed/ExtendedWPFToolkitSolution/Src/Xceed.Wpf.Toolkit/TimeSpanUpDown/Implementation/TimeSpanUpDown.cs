...
namespace Xceed.Wpf.Toolkit
{
  public class TimeSpanUpDown : DateTimeUpDownBase<TimeSpan?>
  {
    ...
    {
        this.DefaultValue = new TimeSpan(0, 0, 0);
    }
    ...
    protected override void OnIncrement()
    {
      ...
      {
          this.Value = (this.Maximum ?? (this.DefaultValue ?? TimeSpan.Zero));
      }
    }
    ...
    protected override void OnDecrement()
    {
      ...
      {
          this.Value = (this.Minimum ?? (this.DefaultValue ?? TimeSpan.Zero));
      }
    }
